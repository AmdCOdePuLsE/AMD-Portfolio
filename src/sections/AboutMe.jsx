...
const AboutMe = () => {
    ...
    return (
        <section
            id="aboutMe"
            ref={sectionRef}
            className="py-20 md:py-28 flex justify-center items-center bg-black text-white"
        >
            <div className="max-w-6xl w-full px-4 md:px-10">
                ...
                <div className="flex flex-col md:flex-row gap-12 md:gap-20 mt-16 items-stretch">
                    ...
                    >
                        ...
                        {/* ✅ Button for iPad (md) only */}
                        <div className="hidden md:block lg:hidden w-full max-w-md mt-6">
                            <a
                                href="https://example.com/your-cv.pdf" //CV link here
                                target="_blank"
                            ...
                            >
                                ...
                                <p className="text relative z-10 text-white">Download My CV</p>
                    ...
                    >
                        ...
                        {/* ✅ Button Group (Responsive + Hover Effects) */}
                        <div className="mt-10 flex flex-col md:hidden lg:flex lg:flex-row gap-5 w-full max-w-md">
