                ...
                <header className="flex flex-col justify-center md:w-full w-screen md:px-20 px-5">
                    <div className="flex flex-col gap-7">
                        <div className="hero-text">
                            <h1 className="flex">
                                Hi!
                                <div className="relative ml-3 md:ml-5 mx-2 h-[60px] md:h-[100px] flex items-center align-baseline -top-[17px] md:-top-[23px] -mb-1 md:-mb-2">
                                    <img
                                        className="h-full w-full object-fill"
                                        src="/images/amdnewlogooo.png"
                                        alt="amd_logo"
                                        loading="lazy"
                                    />
                                </div>
